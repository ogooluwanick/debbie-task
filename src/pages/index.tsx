        ...
        return (
                <main className={`min-h-screen p-4 sm:p-[46px]  w-full flex   items-stretch`} >
                        <section className="relative flex  justify-center flex-col rounded-[32px] px-4 sm:px-[113px]  py-4 sm:py-[94px] w-full" style={{ boxShadow: "0px 1px 2px 0px #09090B0D ,0px 0px 0px 1px #09090B0D" }}>
                                ...
                                <Link href={`/contextual-toolbar`} className="absolute left-6 bottom-6 md:left-[113px] md:bottom-[94px] py-1.5 px-2.5 text-fg-base rounded-lg text-sm font-medium w-fit transition  hover:bg-off-black hover:text-white" style={{ boxShadow: "0px 0px 0px 1px #00000014, 0px 1px 2px 0px #0000001F" }}>Next task</Link>
